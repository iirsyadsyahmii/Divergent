...
public class RestaurantHistory extends AppCompatActivity {
    ...
    TextView date, detail, voucher, remark, users, name,userName,points;
    String username;
    FirebaseAuth fAuth;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Task<QuerySnapshot> citiesRef = fStore.collection("RedeemedVoucher").get()
                        ...
                        if (task.isSuccessful()) {
                            ...
                            for (QueryDocumentSnapshot document : task.getResult()) {
                                if (document.getData().get("Restaurant ID").equals(UID)){
                                    ...
                                    userName.setText(document.getData().get("Customer Name").toString());
                                    voucher.setText(document.getData().get("Offer").toString());

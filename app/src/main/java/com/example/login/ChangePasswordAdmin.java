            ...
            reference
                    ...
                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void aVoid) {
                            Toast.makeText(ChangePasswordAdmin.this, "Password Updated", Toast.LENGTH_SHORT).show();
                            Intent intent = new Intent(ChangePasswordAdmin.this, ProfileAdmin.class);
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(ChangePasswordAdmin.this, "Updating Failed", Toast.LENGTH_SHORT).show();
                            Intent intent = new Intent(ChangePasswordAdmin.this, ProfileAdmin.class);
                            startActivity(intent);
                        }
                    });
